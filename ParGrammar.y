...
Stm : Exp ';' { AbsGrammar.SExp $1 }
    | Type Id ';' { AbsGrammar.SDecl $1 $2 }
    | Type Id ',' ListId ';' { AbsGrammar.SDecls $1 $2 $4 }
...
Exp15 : Integer { AbsGrammar.EInt $1 }
      ...
      | '(' Exp ')' { $2 }
Exp14 :: { Exp }
Exp14 : Exp14 '[' Exp15 ']' { AbsGrammar.EIndex $1 $3 }
      | Exp14 '(' ListExp ')' { AbsGrammar.EFuncall $1 $3 }
      | Exp14 '->' Exp15 { AbsGrammar.EProject $1 $3 }
      | Exp14 '.' Exp15 { AbsGrammar.EStruc $1 $3 }
      | Exp14 '++' { AbsGrammar.EPIncr $1 }
      | Exp14 '--' { AbsGrammar.EPDecr $1 }
      | Exp15 { $1 }
Exp13 :: { Exp }
Exp13 : '++' Exp13 { AbsGrammar.EIncr $2 }
      | '--' Exp13 { AbsGrammar.EDecr $2 }
      | '*' Exp13 { AbsGrammar.EDefren $2 }
      | '!' Exp13 { AbsGrammar.ENegat $2 }
      | Exp14 { $1 }
Exp12 :: { Exp }
Exp12 : Exp12 '*' Exp13 { AbsGrammar.ETimes $1 $3 }
      | Exp12 '/' Exp13 { AbsGrammar.EDiv $1 $3 }
      | Exp12 '%' Exp13 { AbsGrammar.EDRemd $1 $3 }
      | Exp13 { $1 }
Exp11 :: { Exp }
Exp11 : Exp11 '+' Exp12 { AbsGrammar.EPlus $1 $3 }
      ...
      | Exp12 { $1 }
Exp10 :: { Exp }
Exp10 : Exp10 '<<' Exp11 { AbsGrammar.EShiftLeft $1 $3 }
      | Exp10 '>>' Exp11 { AbsGrammar.EShiftRight $1 $3 }
      | Exp11 { $1 }
Exp9 :: { Exp }
Exp9 : Exp9 '<' Exp10 { AbsGrammar.ELt $1 $3 }
     | Exp9 '>' Exp10 { AbsGrammar.EGt $1 $3 }
     | Exp9 '<=' Exp10 { AbsGrammar.ELtEq $1 $3 }
     | Exp9 '>=' Exp10 { AbsGrammar.EGtWq $1 $3 }
     | Exp10 { $1 }
Exp8 :: { Exp }
...
Exp2 : Exp3 '=' Exp2 { AbsGrammar.EAss $1 $3 }
     | Exp3 '+=' Exp2 { AbsGrammar.EAssP $1 $3 }
     | Exp3 '-=' Exp2 { AbsGrammar.EAssM $1 $3 }
     | Exp3 '?' Exp2 ':' Exp2 { AbsGrammar.ECond $1 $3 $5 }
     | Exp3 { $1 }
Exp1 :: { Exp }
Exp1 : 'throw' Exp1 { AbsGrammar.EThrow $2 } | Exp2 { $1 }
Exp :: { Exp }
Exp : Exp1 { $1 }
Exp5 :: { Exp }
Exp5 : Exp6 { $1 }
