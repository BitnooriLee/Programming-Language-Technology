...
instance Print Exp where
  prt i e = case e of
    ...
    EIndex exp1 exp2 -> prPrec i 14 (concatD [prt 14 exp1, doc (showString "["), prt 15 exp2, doc (showString "]")])
    EFuncall exp exps -> prPrec i 14 (concatD [prt 14 exp, doc (showString "("), prt 0 exps, doc (showString ")")])
    EProject exp1 exp2 -> prPrec i 14 (concatD [prt 14 exp1, doc (showString "->"), prt 15 exp2])
    EStruc exp1 exp2 -> prPrec i 14 (concatD [prt 14 exp1, doc (showString "."), prt 15 exp2])
    ...
    EDefren exp -> prPrec i 13 (concatD [doc (showString "*"), prt 13 exp])
    ENegat exp -> prPrec i 13 (concatD [doc (showString "!"), prt 13 exp])
    ...
    EDRemd exp1 exp2 -> prPrec i 12 (concatD [prt 12 exp1, doc (showString "%"), prt 13 exp2])
    ...
    EAssP exp1 exp2 -> prPrec i 2 (concatD [prt 3 exp1, doc (showString "+="), prt 2 exp2])
    EAssM exp1 exp2 -> prPrec i 2 (concatD [prt 3 exp1, doc (showString "-="), prt 2 exp2])
