...
Exp15 : Integer { AbsCpp.EInt $1 }
      ...
      | '(' Exp ')' { $2 }
Exp14 :: { Exp }
Exp14 : Exp14 '[' Exp15 ']' { AbsCpp.EIndex $1 $3 }
      | Exp14 '(' ListExp ')' { AbsCpp.EFuncall $1 $3 }
      | Exp14 '->' Exp15 { AbsCpp.EProject $1 $3 }
      | Exp14 '.' Exp15 { AbsCpp.EStruc $1 $3 }
...
Exp13 : '++' Exp13 { AbsCpp.EIncr $2 }
      ...
      | '*' Exp13 { AbsCpp.EDefren $2 }
      | '!' Exp13 { AbsCpp.ENegat $2 }
      | Exp14 { $1 }
Exp12 :: { Exp }
Exp12 : Exp12 '*' Exp13 { AbsCpp.ETimes $1 $3 }
      | Exp12 '/' Exp13 { AbsCpp.EDiv $1 $3 }
      | Exp12 '%' Exp13 { AbsCpp.EDRemd $1 $3 }
      | Exp13 { $1 }
Exp11 :: { Exp }
...
Exp2 : Exp3 '=' Exp2 { AbsCpp.EAss $1 $3 }
     | Exp3 '+=' Exp2 { AbsCpp.EAssP $1 $3 }
     | Exp3 '-=' Exp2 { AbsCpp.EAssM $1 $3 }
